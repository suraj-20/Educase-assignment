...
const Input = ({
    ...
    <div className="relative w-full">
        <input
            ...
            onChange={onChange}
            placeholder=" "
            className={`peer w-full px-3.5 pt-3 pb-2 text-sm text-[#1D2226] font-medium border rounded-md appearance-none focus:outline-none focus:ring-[0.5px] 
        ${showError
        ...
        <label
            htmlFor={id}
            className={`absolute text-[13px] left-2 -top-2 pl-1.5 pr-2 leading-[17px] bg-[#F7F8F9] font-semibold
...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#F7F8F9] font-sans">
            <div className="bg-[#F7F8F9] w-[375px] h-[670px] border border-gray-200 px-5 py-7 font-sans">
                ...
                <form className="space-y-6 mt-6" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className="bg-[#6C25FF] rounded-md text-white text-base leading-[17px] font-medium w-full h-[46px] cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#5A1EDB] mt-[70px]"
                    >
                        Create Account
                    </button>
                </form>
